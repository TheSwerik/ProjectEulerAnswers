...
public class Problem11 {
    public Problem11() {
        ...
        int rowLength = 20;
        int multiples = 4;
        String[] gridS = {"08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08",
        ...
        for (int i = 0; i < lineLength; i++) {
            for (int j = 0; j < rowLength; j++) {
                grid[i][j] = Integer.parseInt(gridS[i].substring(j * 3, j * 3 + 2));
            }
        }
        ...
        long result = 0;
        boolean[] allowed = {true, true, true, false};
